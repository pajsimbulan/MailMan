  ...
  return (
    <ThemeProvider theme={theme}>
      <FormControl sx={{ marginY: 'auto', marginTop: 5 }}>
        ...
        >
          <FormControlLabel disabled={!edit} value="Female" control={<Radio />} label="Female" />
          <FormControlLabel disabled={!edit} value="Male" control={<Radio />} label="Male" />
          <FormControlLabel disabled={!edit} value="Other" control={<Radio />} label="Other" />
        </RadioGroup>
      </FormControl>
    </ThemeProvider>
  );
